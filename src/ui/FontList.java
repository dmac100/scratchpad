...
public class FontList {
	...
	public static final Font MONO_NORMAL = new Font(Display.getCurrent(), monospaceName, 10, SWT.NORMAL);
	public static final Font MONO_SMALL = new Font(Display.getCurrent(), monospaceName, 8, SWT.NORMAL);
